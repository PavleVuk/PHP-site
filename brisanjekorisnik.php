...
if(isset($_GET['delete'])){
    ...
    mysqli_query ($konekcija, "DELETE from korisnik where JMBG='$JMBG'");
    header('location: brisanjekorisnik.php');
  }
?>
<!doctype html>
<head>
...
<form name="registracija" class="regi" method="get" action="brisanjekorisnik.php" >
<center>
<table class="tabela">
    <caption class="title">Korisnici</caption> <br>
    <thead>
      <tr>
      <th>Redni br.</th>
        <th>JMBG</th>
...
while ($red = mysqli_fetch_array($rezultat0)) {
 ?> 
      <tr>
          ...
          <td><a href="brisanjekorisnik.php?delete=<?php echo $red['JMBG'];$br++;?>"> Izbriši </a> </td>
        </tr>
    <?php } ?>
</form>
</div>
