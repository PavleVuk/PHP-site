...
$upit = "SELECT * FROM mobilni_telefon";
$rezultat0 = mysqli_query($konekcija, $upit);

if(isset($_GET['delete'])){
    $IMEI= $_GET['delete'];
   
    mysqli_query ($konekcija, "DELETE from mobilni_telefon where IMEI='$IMEI'");
    header('location: brisanjemob.php');
  }
...
<form name="registracija" class="regi" method="get" action="brisanjemob.php" >
<center>
<table class="tabela">
    <caption class="title">Mobilni telefoni</caption> <br>
    <thead>
      <tr>
      <th>Redni br.</th>
        <th>IMEI</th>
...
while ($red = mysqli_fetch_array($rezultat0)) {
 ?> 
      <tr>
          ...
          <td><a href="brisanjemob.php?delete=<?php echo $red['IMEI'];$br++;?>"> Izbriši </a> </td>
        </tr>
    <?php } ?>
</form>
</div>
